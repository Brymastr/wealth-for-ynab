<template>
  <div class="flex flex-row self-start flex-wrap text-xl gap-y-3 pb-3 bg-gray-200 shadow-lg rounded-sm">
    ...
    <NetChange class="w-full sm:w-1/2" :netWorth="props.netWorth" />
    <PositiveNegative class="w-full sm:w-1/2" :netWorth="props.netWorth" />
    <AverageChange class="w-full sm:w-1/2" :netWorth="props.netWorth" />
    <BestWorst class="w-full sm:w-1/2" :netWorth="props.netWorth" />
  </div>
</template>
